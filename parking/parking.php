    ...
    <div class="container"> <br>
        <div class="row">
          ...
          <div class="col-6 text-right">
            <a class="btn btn-outline-danger mr-4" href="reports/report_parking.php" title="Generar reporte">
              ...
              foreach($mappings as $mapping){
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <center>
                        <a href="forms/delete.php?id=<?php echo $id_map; ?>" title="Eliminar" class="btn btn-danger">
