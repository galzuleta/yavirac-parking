...
$ticket_status = "OCUPADO";
$user_session = $_GET['user_session'];


$sentence = $pdo->prepare("INSERT INTO tickets 
                        (plate, name_customer, lastname_customer, identification, type_transport, type_customer, cubicle, entry_date, entry_time, out_date, ticket_status, user_session) 
                        VALUES (:plate,:name_customer, :lastname_customer, :identification, :type_transport, :type_customer, :cubicle, :entry_date, :entry_time, :out_date, :ticket_status, :user_session)");
...
$sentence->bindParam('out_date', $out_date);
$sentence->bindParam('ticket_status', $ticket_status);
