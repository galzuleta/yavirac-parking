    ...
    <div class="container"> <br>
      <div class="row">
        ...
        <div class="col-6 text-right">
          <a href="reports/report_ticket.php" class="btn btn-outline-danger mr-4" title="Generar reporte" >
                    ...
                    <tr>
                        ...
                        <td> <?php echo $observation;?>
                            ...
                            <div class="d-flex justify-content-end">
                                ...
                                <a href="../tickets/forms/reprint_ticket.php?id=<?php echo $id;?>" title="Re-imprimir ticket" class="btn btn-info"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-printer-fill" viewBox="0 0 16 16">
                                    ...
                                    <div class="modal-content " style="background-color:rgb(245,245,245);">
                                        <form action="../observations/controllers/controller_partial.php" method="post">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button id="cancelar_o" type="button" class="btn btn-danger" data-dismiss="modal">Cancelar</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
