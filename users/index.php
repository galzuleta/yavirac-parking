...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <div class="container">
      <div class="row m-4">
        <a href="<?php echo $URL;?>/users/forms/created.php" class="btn btn-secondary" tabindex="-1" role="button" aria-disabled="true">
        ...
        <table class="table table-bordered table-sm table-striped">
          ...
          foreach($usuarios as $usuario){
            ...
            ?>
              ...
              <td>
                  <center>
                    <a href="forms/updated.php?id=<?php echo $id; ?>" class="btn btn-success">
                ...
                <td>
                  <center>
                    <a href="forms/delete.php?id=<?php echo $id; ?>" class="btn btn-danger">
                    ...
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalRoles<?php echo $id;?>">
